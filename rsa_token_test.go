...
func TestParseRSAToken(t *testing.T) {
	...
	mgr, err := CreateRSAToken("./test/jwtRS256.key.pub", "./test/jwtRS256.key")
	if err != nil {
		t.Fail()
	}
	tk, err := mgr.GenerateToken(Claims{UserId: 1}, 30*time.Minute)
